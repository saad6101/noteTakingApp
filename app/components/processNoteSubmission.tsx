...
export function processNoteSubmission(SECRET_KEY: string, setNoteHeading: React.Dispatch<React.SetStateAction<string>>, setNoteContent: React.Dispatch<React.SetStateAction<string>>) {
